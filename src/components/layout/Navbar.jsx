...
const Navbar = () => {
    ...
    return (
        <nav className={`w-full h-[10vh] flex-box justify-between gap-5 px-3 lg:px-10 backdrop-blur-sm z-30 ${pathname == '/' ? "text-white" : ""}`}>
            ...
            <div className="flex-box  lg:gap-4">
                {!context.USER.isAuth ? (
                    <div className="flex-box gap-2 lg:gap-5">
                        <button className=" p-2 bg-orange-200 dark:bg-orange-500 group rounded-full" onClick={themeSwitch}>
                            {theme == "light" ? (
                    ...
                    <div className="flex-box gap-5 ">
                        ...
                        <div className=" w-full group flex-box gap-3 relative">
                            ...
                            <div className="absolute top-14 group-hover:visible opacity-0 group-hover:opacity-100 invisible duration-300    bg-[#fffefebd] dark:bg-[#171717ee] shadow-[rgba(0,_0,_0,_0.2)_0px_10px_20px_-7px] rounded-2xl ">
                                <ul className="w-full h-full flex-box flex-col justify-evenly text-black dark:text-white gap-3 py-3 px-2">
                                    <li className=" w-full flex-box justify-start hover:bg-stone-200 hover:text-sky-400 dark:hover:bg-zinc-800  duration-300 rounded-2xl px-3 py-1">
                                        ...
                                        <Link to={'/profile'} className="px-3 py-2 text-md font-medium text-start">
                                            Profile
                                        </Link>
                                    </li>
                                    <li className=" w-full flex-box justify-start hover:bg-stone-200 hover:text-orange-400 dark:hover:bg-zinc-800  duration-300 rounded-2xl px-3 py-1">
                                        ...
                                        <Link to={'/notes/1'} className=" px-3 py-2 text-md font-medium text-start">
                                            Notes
                                        </Link>
                                    </li>
                                    ...
                                    <li className=" w-full flex-box justify-start  hover:bg-stone-200 hover:text-green-500 dark:hover:bg-zinc-800  duration-300 rounded-2xl px-3 py-1">
                                            ...
                                            <Link to={'/addnote'} className=" px-3 py-2 text-md font-medium text-start">
                ...
                <div className="flex-col flex flex-box lg:hidden  overflow-hidden p-3">
                    {isExtended == true ? 
                        <>
                            <RxCross2 className="text-2xl " onClick={()=>setIsExtended(false)} />
                        ...
                        <ul className="w-full h-full flex-box flex-col justify-evenly  gap-3 py-3 px-2">
                            <li className=" w-full flex-box justify-center hover:bg-stone-200 hover:text-sky-400 dark:hover:bg-zinc-800  duration-300 rounded-2xl px-3 py-1">
                                <Link to={'/'} onClick={()=>setIsExtended(false)} className="px-3 py-2 text-md font-medium text-center">
                                    Home
                                </Link>
                            </li>
                            <li className=" w-full flex-box justify-center hover:bg-stone-200 hover:text-orange-400 dark:hover:bg-zinc-800  duration-300 rounded-2xl px-3 py-1">
                                <Link to={'/about'} onClick={()=>setIsExtended(false)} className=" px-3 py-2 text-md font-medium text-center">
                                    About
                                </Link>
                            </li>
                            <li className=" w-full flex-box justify-center  hover:bg-stone-200 hover:text-green-500 dark:hover:bg-zinc-800  duration-300 rounded-2xl px-3 py-1">
                                <Link to={'/explore'} onClick={()=>setIsExtended(false)} className=" px-3 py-2 text-md font-medium text-center">
                                    Explore
                                </Link>
                            </li>
                        </ul>
                    ...
                    : 
                    <RxHamburgerMenu className="text-2xl " onClick={()=>setIsExtended(true)}/>
                }
