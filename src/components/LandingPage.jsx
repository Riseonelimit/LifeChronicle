...
const LandingPage = () => {
  ...
  return (
    <section className="relative w-full flex flex-col items-center gap-[10rem]">
      ...
      <div className="relative w-3/4 h-[70vh] z-10 my-[5rem] px-[5rem] py-4 flex-box justify-evenly  bg-[#fff7f139] dark:bg-[#2e2c2860] duration-300 rounded-[20px] shadow-[rgba(0,_0,_0,_0.2)_0px_60px_40px_-7px] backdrop-blur-md">
        <div className="flex-box flex-col items-start w-[30%] h-[80%] z-10 justify-evenly">
        <h1 className="text-sm lg:text-7xl md:text-7xl font-[300] text-white items-center justify-center ">
          100 Days<br/>can be 
        ...
        <button onClick={handleStartedClick} className=" px-4 flex justify-center items-center py-3 bg-orange-400 hover:bg-orange-600  duration-300 rounded-[10px] font-[500] text-white shadow-[0_10px_40px_-15px_rgba(0,0,0,0.3)]">Get Started <BsArrowRightShort size={30}/></button>
        </div>

        <div className="w-[70%] z-10 h-full ">
