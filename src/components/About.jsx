...
const About = () => {
    return (
        <div className="flex overflow-hidden rounded-[10px]  z-10 lg:items-center sm:items-start lg:flex-row md:flex-row sm:flex-row sm:h-screen w-3/4 justify-evenly my-[5rem]">
            ...
            {/* </div> */}
            <div  className="w-[75%] z-10  flex flex-col items-start justify-start gap-10">
                <div className="w-full group flex flex-col gap-10 ">
                    ...
                    <h1 className="text-8xl text-zinc-400 dark:text-white font-[400] inter ">
                        What is{" "}
                        <span className="duration-500 bg-gradient-to-tl dark:from-red-600 dark:to-yellow-400  from-orange-400 to-yellow-400  text-transparent bg-clip-text">
                            Life Chronicle ?
                        </span>
                    </h1>
                ...
                <div className="group flex-box flex-col gap-5 relative">
                    <p className="text-slate-500 dark:text-[#ddf6f6] md:leading-9  lg:leading-9 lg:text-base md:lg:text-base text-xs j " >
                        Our platform empowers you to embark on a transformative
                        100-day challenge, where you can chronicle your life,
                        one entry at a time. Whether you're sharing personal
                        achievements, reflecting on challenges, or simply
                        celebrating the beauty of everyday moments,
                        LifeChronicle is here to be your digital journal and
                        companion.
                    </p>
                    ...
                    <p className="text-slate-500 dark:text-[#ddf6f6]  leading-9">
                        Our mission is to inspire, connect, and uplift
                        individuals on their life's voyage. With a supportive
                        community of fellow chronicle enthusiasts, you'll find
                        encouragement, motivation, and a shared sense of
                        purpose.
                    </p>
                </div>
            </div>
