...
const NotePageSidebar = () => {
    ...
    return (
        <>
            <div className="grid relative md:grid-rows-3 lg:grid-rows-3 z-10 lg:gap-5 md:col-span-2 lg:col-span-2 overflow-hidden border-red-500 px-3 lg:py-5">
                <div className="row-span-2 flex flex-col justify-center self-start lg:self-auto gap-3 pb-1  ">
                    ...
                    <div className="w-full lg:h-[85%] flex-box flex-col justify-start overflow-y-auto no-scrollbar">
                        <MemoryCardsRender
            ...
            {isCommentBox && noteData["noteData"] != null ? (
                <CommentBox
                    setIsCommentBox={setIsCommentBox}
                    noteID={noteData["noteData"]["note_id"]}
                />
            ) : null}

            {
                ...
                noteData["noteData"] != null ? (
                    <div
                        className={
                            "absolute w-[70rem] dark:bg-[#151313fd] bg-[#fffffff9] flex-box flex-col gap-3 rounded-[2em] left-[20%] bottom-[10%] z-20 px-8 py-5 visible shadow-[rgba(0,_0,_0,_0.2)_0px_60px_40px_-7px]"
                        }
                    >
                        <div className=" flex-box justify-between w-full">
                            <h1 className="md:text-[1rem] lg:text-[1.8rem] inter font-[700] bg-gradient-to-tl dark:from-red-600 dark:to-orange-400  from-yellow-400 to-orange-400  text-transparent bg-clip-text">
                                Images
                            </h1>
                            <IoMdClose
                                onClick={() => {
